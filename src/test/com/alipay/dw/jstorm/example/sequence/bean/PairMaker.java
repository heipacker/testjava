...
public class PairMaker {
	private static final String[] tradeType = new String[] { "trade_one", "trade_two", "trade_three", "trade_four", "trade_five", "trade_six", "trade_seven", "trade_eight", "trade_nine", "trade_ten" };

	private static final String[] customerType = new String[] { "customer_a", "customer_b", "customer_c", "customer_d", "customer_e", "customer_f" };
